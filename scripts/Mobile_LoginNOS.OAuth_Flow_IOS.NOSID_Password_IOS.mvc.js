define("Mobile_LoginNOS.OAuth_Flow_IOS.NOSID_Password_IOS.mvc$model", ["OutSystems", "Mobile_LoginNOS.model", "Mobile_LoginNOS.controller", "MobileUIWidgets.WidgetsContent.CardFlex.mvc$model", "MobileUIWidgets.WidgetsContent.NOSAppsIcons.mvc$model", "SFAuthenticationPlugin.Main_SFAuthentication.SF_Authentication.mvc$model", "Mobile_LoginNOS.controller$Audit", "Mobile_LoginNOS.controller$ViewControllerValidation", "Mobile_LoginNOS.controller$BuildApplicationIdentifier", "Mobile_LoginNOS.model$WebView_ParametersRec"], function (OutSystems, Mobile_LoginNOSModel, Mobile_LoginNOSController, MobileUIWidgets_WidgetsContent_CardFlex_mvcModel, MobileUIWidgets_WidgetsContent_NOSAppsIcons_mvcModel, SFAuthenticationPlugin_Main_SFAuthentication_SF_Authentication_mvcModel) {
...
define("Mobile_LoginNOS.OAuth_Flow_IOS.NOSID_Password_IOS.mvc$view", ["OutSystems", "Mobile_LoginNOS.model", "Mobile_LoginNOS.controller", "react", "OutSystemsReactView", "Mobile_LoginNOS.OAuth_Flow_IOS.NOSID_Password_IOS.mvc$model", "Mobile_LoginNOS.OAuth_Flow_IOS.NOSID_Password_IOS.mvc$controller", "MobileUIWidgets.WidgetsContent.CardFlex.mvc$view", "OutSystemsReactWidgets", "MobileUIWidgets.WidgetsContent.NOSAppsIcons.mvc$view", "SFAuthenticationPlugin.Main_SFAuthentication.SF_Authentication.mvc$view", "Mobile_LoginNOS.controller$Audit", "Mobile_LoginNOS.controller$ViewControllerValidation", "Mobile_LoginNOS.controller$BuildApplicationIdentifier", "Mobile_LoginNOS.model$WebView_ParametersRec"], function (OutSystems, Mobile_LoginNOSModel, Mobile_LoginNOSController, React, OSView, Mobile_LoginNOS_OAuth_Flow_IOS_NOSID_Password_IOS_mvc_model, Mobile_LoginNOS_OAuth_Flow_IOS_NOSID_Password_IOS_mvc_controller, MobileUIWidgets_WidgetsContent_CardFlex_mvc_view, OSWidgets, MobileUIWidgets_WidgetsContent_NOSAppsIcons_mvc_view, SFAuthenticationPlugin_Main_SFAuthentication_SF_Authentication_mvc_view) {
    var OS = OutSystems.Internal;
...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    var View = (function (_super) {
        ...
        View.displayName = "OAuth_Flow_IOS.NOSID_Password_IOS";
        ...
        Object.defineProperty(View.prototype, "modelFactory", {
            get: function () {
                return Mobile_LoginNOS_OAuth_Flow_IOS_NOSID_Password_IOS_mvc_model;
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(View.prototype, "controllerFactory", {
            get: function () {
                return Mobile_LoginNOS_OAuth_Flow_IOS_NOSID_Password_IOS_mvc_controller;
            },
            enumerable: true,
            configurable: true
        });
...
controller.passwordOnNOSID$Action(controller.callContext(eventHandlerContext));
});
;
}
},
...
value: "Altere o seu acesso seguro nas apps NOS",
_idProps: {
service: idService,
uuid: "2"
},
...
define("Mobile_LoginNOS.OAuth_Flow_IOS.NOSID_Password_IOS.mvc$controller", ["OutSystems", "Mobile_LoginNOS.model", "Mobile_LoginNOS.controller", "Mobile_LoginNOS.languageResources", "Mobile_LoginNOS.controller$Audit", "Mobile_LoginNOS.controller$ViewControllerValidation", "Mobile_LoginNOS.controller$BuildApplicationIdentifier", "Mobile_LoginNOS.model$WebView_ParametersRec"], function (OutSystems, Mobile_LoginNOSModel, Mobile_LoginNOSController, Mobile_LoginNOSLanguageResources) {
var OS = OutSystems.Internal;
...
// Server Actions
Controller.prototype.password$ServerAction = function (callBackURLIn, callContext) {
var controller = this.controller;
var inputs = {
CallBackURL: OS.DataTypes.JSConversions.basicTypeToJS(callBackURLIn, OS.Types.Text)
};
return controller.callServerAction("Password", "screenservices/Mobile_LoginNOS/OAuth_Flow_IOS/NOSID_Password_IOS/ActionPassword", "XE7DAqfmdD6eZ63EJOapXw", inputs, controller.callContext(callContext)).then(function (outputs) {
var executeServerActionResult = new (controller.constructor.getVariableGroupType("Mobile_LoginNOS.OAuth_Flow_IOS.NOSID_Password_IOS$ActionPassword"))();
executeServerActionResult.uRLOut = OS.DataTypes.JSConversions.jsToBasicType(outputs.URL, OS.Types.Text);
return executeServerActionResult;
});
};
Controller.registerVariableGroupType("Mobile_LoginNOS.OAuth_Flow_IOS.NOSID_Password_IOS$ActionPassword", [{
name: "URL",
attrName: "uRLOut",
mandatory: false,
...
var vars = new OS.DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("Mobile_LoginNOS.OAuth_Flow_IOS.NOSID_Password_IOS.SF_AuthenticationOnError$vars"))());
vars.value.messageInLocal = messageIn;
return OS.Flow.executeAsyncFlow(function () {
// Trigger Event: Logout_Error
return controller.password_Error$Action(vars.value.messageInLocal, callContext);
});
};
Controller.registerVariableGroupType("Mobile_LoginNOS.OAuth_Flow_IOS.NOSID_Password_IOS.SF_AuthenticationOnError$vars", [{
name: "Message",
...
Controller.prototype._passwordOnNOSID$Action = function (callContext) {
var model = this.model;
var controller = this.controller;
var idService = this.idService;
controller.ensureControllerAlive("PasswordOnNOSID");
callContext = controller.callContext(callContext);
var allExceptionsVar = new OS.DataTypes.VariableHolder(new OS.DataTypes.ErrorHandlerOutputType());
var passwordVar = new OS.DataTypes.VariableHolder();
...
return controller.password_Error$Action(viewControllerValidationVar.value.errorMessageOut, callContext);
} else {
...
return controller.password_Error$Action(buildApplicationIdentifierVar.value.error_MessageOut, callContext);
} else {
...
// Execute Action: Password
model.flush();
return controller.password$ServerAction(model.variables.callBackURLVar, callContext).then(function (value) {
passwordVar.value = value;
}).then(function () {
// Execute Action: Audit
Mobile_LoginNOSController.default.audit$Action(model.variables.applicationNameIn, ("NOSID_Password_IOS | URL End Point: " + passwordVar.value.uRLOut), callContext);
// URL_EndPoint = Password.URL
model.variables.uRL_EndPointVar = passwordVar.value.uRLOut;
// IsVisible = True
model.variables.isVisibleVar = true;
// Trigger Event: Password_Start
return controller.password_Start$Action(callContext);
});
}
...
OS.Logger.trace("NOSID_Password_IOS.PasswordOnNOSID", OS.Exceptions.getMessage(ex), ex.name);
...
Controller.prototype.passwordOnNOSID$Action = function (callContext) {
var controller = this.controller;
return controller.safeExecuteClientAction(controller._passwordOnNOSID$Action, callContext);
...
Controller.prototype.password_Start$Action = function () {
return Promise.resolve();
};
