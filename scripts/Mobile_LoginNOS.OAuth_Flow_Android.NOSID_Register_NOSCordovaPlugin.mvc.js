define("Mobile_LoginNOS.OAuth_Flow_Android.NOSID_Register_NOSCordovaPlugin.mvc$model", ["OutSystems", "Mobile_LoginNOS.model", "Mobile_LoginNOS.controller", "NOSCordovaPlugin.controller", "CommonPlugin.model", "BuildInfoPlugin.controller", "MobileUIWidgets.WidgetsContent.ButtonRipple.mvc$model", "NOSCordovaPlugin.PluginFlow.ShowWebViewListener.mvc$model", "Mobile_LoginNOS.controller$setActivityLog_ClickEvents", "Mobile_LoginNOS.model$STR_LogNameValueRecordList", "NOSCordovaPlugin.controller$ShowInternalBrowser", "Mobile_LoginNOS.referencesHealth", "Mobile_LoginNOS.referencesHealth$NOSCordovaPlugin", "CommonPlugin.model$ErrorRec", "Mobile_LoginNOS.referencesHealth$CommonPlugin", "BuildInfoPlugin.controller$GetBuildInfo", "Mobile_LoginNOS.referencesHealth$BuildInfoPlugin", "Mobile_LoginNOS.controller$Audit", "Mobile_LoginNOS.model$AccessTokenCodeRec"], function (OutSystems, Mobile_LoginNOSModel, Mobile_LoginNOSController, NOSCordovaPluginController, CommonPluginModel, BuildInfoPluginController, MobileUIWidgets_WidgetsContent_ButtonRipple_mvcModel, NOSCordovaPlugin_PluginFlow_ShowWebViewListener_mvcModel) {
...
define("Mobile_LoginNOS.OAuth_Flow_Android.NOSID_Register_NOSCordovaPlugin.mvc$view", ["OutSystems", "Mobile_LoginNOS.model", "Mobile_LoginNOS.controller", "NOSCordovaPlugin.controller", "CommonPlugin.model", "BuildInfoPlugin.controller", "react", "OutSystemsReactView", "Mobile_LoginNOS.OAuth_Flow_Android.NOSID_Register_NOSCordovaPlugin.mvc$model", "Mobile_LoginNOS.OAuth_Flow_Android.NOSID_Register_NOSCordovaPlugin.mvc$controller", "MobileUIWidgets.WidgetsContent.ButtonRipple.mvc$view", "OutSystemsReactWidgets", "NOSCordovaPlugin.PluginFlow.ShowWebViewListener.mvc$view", "Mobile_LoginNOS.controller$setActivityLog_ClickEvents", "Mobile_LoginNOS.model$STR_LogNameValueRecordList", "NOSCordovaPlugin.controller$ShowInternalBrowser", "Mobile_LoginNOS.referencesHealth", "Mobile_LoginNOS.referencesHealth$NOSCordovaPlugin", "CommonPlugin.model$ErrorRec", "Mobile_LoginNOS.referencesHealth$CommonPlugin", "BuildInfoPlugin.controller$GetBuildInfo", "Mobile_LoginNOS.referencesHealth$BuildInfoPlugin", "Mobile_LoginNOS.controller$Audit", "Mobile_LoginNOS.model$AccessTokenCodeRec"], function (OutSystems, Mobile_LoginNOSModel, Mobile_LoginNOSController, NOSCordovaPluginController, CommonPluginModel, BuildInfoPluginController, React, OSView, Mobile_LoginNOS_OAuth_Flow_Android_NOSID_Register_NOSCordovaPlugin_mvc_model, Mobile_LoginNOS_OAuth_Flow_Android_NOSID_Register_NOSCordovaPlugin_mvc_controller, MobileUIWidgets_WidgetsContent_ButtonRipple_mvc_view, OSWidgets, NOSCordovaPlugin_PluginFlow_ShowWebViewListener_mvc_view) {
    var OS = OutSystems.Internal;
...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    var View = (function (_super) {
        ...
        View.displayName = "OAuth_Flow_Android.NOSID_Register_NOSCordovaPlugin";
        ...
        Object.defineProperty(View.prototype, "modelFactory", {
            get: function () {
                return Mobile_LoginNOS_OAuth_Flow_Android_NOSID_Register_NOSCordovaPlugin_mvc_model;
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(View.prototype, "controllerFactory", {
            get: function () {
                return Mobile_LoginNOS_OAuth_Flow_Android_NOSID_Register_NOSCordovaPlugin_mvc_controller;
            },
            enumerable: true,
            configurable: true
        });
...
controller.registerOnNOSID$Action(controller.callContext(eventHandlerContext));
});
;
},
...
define("Mobile_LoginNOS.OAuth_Flow_Android.NOSID_Register_NOSCordovaPlugin.mvc$controller", ["OutSystems", "Mobile_LoginNOS.model", "Mobile_LoginNOS.controller", "NOSCordovaPlugin.controller", "CommonPlugin.model", "BuildInfoPlugin.controller", "Mobile_LoginNOS.languageResources", "Mobile_LoginNOS.OAuth_Flow_Android.NOSID_Register_NOSCordovaPlugin.mvc$controller.ShowWebViewListenerOnLoginSuccess.GetUrlParametersJS", "Mobile_LoginNOS.controller$setActivityLog_ClickEvents", "Mobile_LoginNOS.model$STR_LogNameValueRecordList", "NOSCordovaPlugin.controller$ShowInternalBrowser", "Mobile_LoginNOS.referencesHealth", "Mobile_LoginNOS.referencesHealth$NOSCordovaPlugin", "CommonPlugin.model$ErrorRec", "Mobile_LoginNOS.referencesHealth$CommonPlugin", "BuildInfoPlugin.controller$GetBuildInfo", "Mobile_LoginNOS.referencesHealth$BuildInfoPlugin", "Mobile_LoginNOS.controller$Audit", "Mobile_LoginNOS.model$AccessTokenCodeRec"], function (OutSystems, Mobile_LoginNOSModel, Mobile_LoginNOSController, NOSCordovaPluginController, CommonPluginModel, BuildInfoPluginController, Mobile_LoginNOSLanguageResources, Mobile_LoginNOS_OAuth_Flow_Android_NOSID_Register_NOSCordovaPlugin_mvc_controller_ShowWebViewListenerOnLoginSuccess_GetUrlParametersJS) {
var OS = OutSystems.Internal;
...
// Server Actions
Controller.prototype.registration_v2$ServerAction = function (applicationIn, doLoggingIn, correlationIdIn, callBackURLIn, clientIdIn, log_ExtendedParameterListIn, callContext) {
var controller = this.controller;
var inputs = {
...
return controller.callServerAction("Registration_v2", "screenservices/Mobile_LoginNOS/OAuth_Flow_Android/NOSID_Register_NOSCordovaPlugin/ActionRegistration_v2", "NlXfMZ+yEa7Xk6a9U2Tkcg", inputs, controller.callContext(callContext)).then(function (outputs) {
var executeServerActionResult = new (controller.constructor.getVariableGroupType("Mobile_LoginNOS.OAuth_Flow_Android.NOSID_Register_NOSCordovaPlugin$ActionRegistration_v2"))();
...
Controller.registerVariableGroupType("Mobile_LoginNOS.OAuth_Flow_Android.NOSID_Register_NOSCordovaPlugin$ActionRegistration_v2", [{
name: "URL",
attrName: "uRLOut",
mandatory: false,
...
return controller.callServerAction("AccessTokenCode", "screenservices/Mobile_LoginNOS/OAuth_Flow_Android/NOSID_Register_NOSCordovaPlugin/ActionAccessTokenCode", "W4TH0NcwyvJznDkgZkvDrw", inputs, controller.callContext(callContext)).then(function (outputs) {
var executeServerActionResult = new (controller.constructor.getVariableGroupType("Mobile_LoginNOS.OAuth_Flow_Android.NOSID_Register_NOSCordovaPlugin$ActionAccessTokenCode"))();
executeServerActionResult.accessTokenInfoOut = Mobile_LoginNOSModel.AccessTokenCodeRec.fromJS(outputs.AccessTokenInfo);
return executeServerActionResult;
});
};
Controller.registerVariableGroupType("Mobile_LoginNOS.OAuth_Flow_Android.NOSID_Register_NOSCordovaPlugin$ActionAccessTokenCode", [{
...
// Trigger Event: Register_WebViewOpened
return controller.register_WebViewOpened$Action(callContext);
});
};
...
callContext = controller.callContext(callContext);
var vars = new OS.DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("Mobile_LoginNOS.OAuth_Flow_Android.NOSID_Register_NOSCordovaPlugin.ShowWebViewListenerOnError$vars"))());
vars.value.errorInLocal = errorIn;
return OS.Flow.executeAsyncFlow(function () {
// Trigger Event: Event_CallBackError
return controller.register_Error$Action(vars.value.errorInLocal, callContext);
});
};
Controller.registerVariableGroupType("Mobile_LoginNOS.OAuth_Flow_Android.NOSID_Register_NOSCordovaPlugin.ShowWebViewListenerOnError$vars", [{
name: "Error",
...
Controller.prototype._registerOnNOSID$Action = function (callContext) {
var model = this.model;
var controller = this.controller;
var idService = this.idService;
controller.ensureControllerAlive("RegisterOnNOSID");
callContext = controller.callContext(callContext);
var allExceptionsVar = new OS.DataTypes.VariableHolder(new OS.DataTypes.ErrorHandlerOutputType());
var registration_v3Var = new OS.DataTypes.VariableHolder();
var getBuildInfoVar = new OS.DataTypes.VariableHolder();
return OS.Flow.executeAsyncFlow(function () {
// Execute Action: setActivityLog_ClickEvents
model.flush();
return Mobile_LoginNOSController.default.setActivityLog_ClickEvents$Action(true, model.variables.applicationNameIn, callContext).then(function () {
...
// Execute Action: Registration_v3
model.flush();
return controller.registration_v2$ServerAction(model.variables.applicationNameIn, true, "", model.variables.callBackURLVar, model.variables.clientIdIn, new Mobile_LoginNOSModel.STR_LogNameValueRecordList(), callContext).then(function (value) {
registration_v3Var.value = value;
});
}).then(function () {
// Code_Verifier
// Code_Verifier = Registration_v3.CodeVerifier
model.variables.code_VerifierVar = registration_v3Var.value.codeVerifierOut;
// Execute Action: ShowInternalBrowser
NOSCordovaPluginController.default.showInternalBrowser$Action(registration_v3Var.value.uRLOut, "Registar-me", model.variables.headerColorIn, model.variables.isDebugModeIn, "login", false, callContext);
});
}).catch(function (ex) {
OS.Logger.trace("NOSID_Register_NOSCordovaPlugin.RegisterOnNOSID", OS.Exceptions.getMessage(ex), ex.name);
...
callContext = controller.callContext(callContext);
var vars = new OS.DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("Mobile_LoginNOS.OAuth_Flow_Android.NOSID_Register_NOSCordovaPlugin.ShowWebViewListenerOnLoginSuccess$vars"))());
...
return OS.Flow.executeAsyncFlow(function () {
getUrlParametersJSResult.value = controller.safeExecuteJSNode(Mobile_LoginNOS_OAuth_Flow_Android_NOSID_Register_NOSCordovaPlugin_mvc_controller_ShowWebViewListenerOnLoginSuccess_GetUrlParametersJS, "GetUrlParameters", "ShowWebViewListenerOnLoginSuccess", {
...
var jsNodeResult = new (controller.constructor.getVariableGroupType("Mobile_LoginNOS.OAuth_Flow_Android.NOSID_Register_NOSCordovaPlugin.ShowWebViewListenerOnLoginSuccess$getUrlParametersJSResult"))();
...
return controller.register_Error$Action(vars.value.errorMessageVar, callContext);
} else {
// Trigger Event: Register_Closed
return controller.register_Closed$Action(accessTokenCodeVar.value.accessTokenInfoOut, false, vars.value.browserInLocal, callContext);
}
...
Controller.registerVariableGroupType("Mobile_LoginNOS.OAuth_Flow_Android.NOSID_Register_NOSCordovaPlugin.ShowWebViewListenerOnLoginSuccess$vars", [{
name: "Url",
attrName: "urlInLocal",
mandatory: true,
dataType: OS.Types.Text,
...
Controller.registerVariableGroupType("Mobile_LoginNOS.OAuth_Flow_Android.NOSID_Register_NOSCordovaPlugin.ShowWebViewListenerOnLoginSuccess$getUrlParametersJSResult", [{
name: "code",
attrName: "codeOut",
mandatory: true,
dataType: OS.Types.Text,
...
Controller.prototype.registerOnNOSID$Action = function (callContext) {
var controller = this.controller;
return controller.safeExecuteClientAction(controller._registerOnNOSID$Action, callContext);
...
Controller.prototype.register_Closed$Action = function () {
return Promise.resolve();
};
Controller.prototype.register_WebViewOpened$Action = function () {
return Promise.resolve();
};
...
define("Mobile_LoginNOS.OAuth_Flow_Android.NOSID_Register_NOSCordovaPlugin.mvc$controller.ShowWebViewListenerOnLoginSuccess.GetUrlParametersJS", [], function () {
