define("WTF_MOB.ZonaFlow.WTF_AditivosChoose_Error.mvc$model", ["OutSystems", "WTF_MOB.model", "MobileUIWidgets.controller", "WTF_MOB.controller", "WTF_MOB.Common.LayoutBlank.mvc$model", "MobileUIWidgets.WidgetsContent.EmptyStatesV3_Text.mvc$model", "MobileUIWidgets.WidgetsContent.ButtonRipple.mvc$model", "MobileUIWidgets.controller$CustomFeedbackMessage", "WTF_MOB.referencesHealth", "WTF_MOB.referencesHealth$MobileUIWidgets", "WTF_MOB.controller$Analytics_TrackException", "WTF_MOB.controller$VerifyNetworkStatus", "WTF_MOB.controller$Analytics_SendEvent", "WTF_MOB.controller$StopTraceGlobalAction", "WTF_MOB.controller$StartTraceGlobalAction", "WTF_MOB.model$AnalyticsAuxVarRec"], function (OutSystems, WTF_MOBModel, MobileUIWidgetsController, WTF_MOBController, WTF_MOB_Common_LayoutBlank_mvcModel, MobileUIWidgets_WidgetsContent_EmptyStatesV3_Text_mvcModel, MobileUIWidgets_WidgetsContent_ButtonRipple_mvcModel) {
...
this.attr("ErrorSubTitle", "errorSubTitleIn", "ErrorSubTitle", true, OS.Types.Text, function () {
return "";
}), 
this.attr("_errorSubTitleInDataFetchStatus", "_errorSubTitleInDataFetchStatus", "_errorSubTitleInDataFetchStatus", true, OS.Types.Integer, function () {
return /*Fetched*/ 1;
}), 
this.attr("ErrorDesc", "errorDescIn", "ErrorDesc", true, OS.Types.Text, function () {
return "";
}), 
this.attr("_errorDescInDataFetchStatus", "_errorDescInDataFetchStatus", "_errorDescInDataFetchStatus", true, OS.Types.Integer, function () {
return /*Fetched*/ 1;
}), 
this.attr("ErrorWithChargeBtn", "errorWithChargeBtnIn", "ErrorWithChargeBtn", true, OS.Types.Boolean, function () {
return false;
}), 
this.attr("_errorWithChargeBtnInDataFetchStatus", "_errorWithChargeBtnInDataFetchStatus", "_errorWithChargeBtnInDataFetchStatus", true, OS.Types.Integer, function () {
return /*Fetched*/ 1;
})
...
if("ErrorSubTitle" in inputs) {
this.variables.errorSubTitleIn = OS.DataTypes.JSConversions.jsToBasicType(inputs.ErrorSubTitle, OS.Types.Text);
}

if("ErrorDesc" in inputs) {
this.variables.errorDescIn = OS.DataTypes.JSConversions.jsToBasicType(inputs.ErrorDesc, OS.Types.Text);
}

if("ErrorWithChargeBtn" in inputs) {
this.variables.errorWithChargeBtnIn = OS.DataTypes.JSConversions.jsToBasicType(inputs.ErrorWithChargeBtn, OS.Types.Boolean);
}
...
define("WTF_MOB.ZonaFlow.WTF_AditivosChoose_Error.mvc$view", ["OutSystems", "WTF_MOB.model", "WTF_MOB.controller", "MobileUIWidgets.controller", "react", "OutSystemsReactView", "WTF_MOB.ZonaFlow.WTF_AditivosChoose_Error.mvc$model", "WTF_MOB.ZonaFlow.WTF_AditivosChoose_Error.mvc$controller", "WTF_MOB.Common.LayoutBlank.mvc$view", "OutSystemsReactWidgets", "MobileUIWidgets.WidgetsContent.EmptyStatesV3_Text.mvc$view", "MobileUIWidgets.WidgetsContent.ButtonRipple.mvc$view", "MobileUIWidgets.controller$CustomFeedbackMessage", "WTF_MOB.referencesHealth", "WTF_MOB.referencesHealth$MobileUIWidgets", "WTF_MOB.controller$Analytics_TrackException", "WTF_MOB.controller$VerifyNetworkStatus", "WTF_MOB.controller$Analytics_SendEvent", "WTF_MOB.controller$StopTraceGlobalAction", "WTF_MOB.controller$StartTraceGlobalAction", "WTF_MOB.model$AnalyticsAuxVarRec"], function (OutSystems, WTF_MOBModel, WTF_MOBController, MobileUIWidgetsController, React, OSView, WTF_MOB_ZonaFlow_WTF_AditivosChoose_Error_mvc_model, WTF_MOB_ZonaFlow_WTF_AditivosChoose_Error_mvc_controller, WTF_MOB_Common_LayoutBlank_mvc_view, OSWidgets, MobileUIWidgets_WidgetsContent_EmptyStatesV3_Text_mvc_view, MobileUIWidgets_WidgetsContent_ButtonRipple_mvc_view) {
    var OS = OutSystems.Internal;
...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    var View = (function (_super) {
        ...
        View.displayName = "ZonaFlow.WTF_AditivosChoose_Error";
        View.getCssDependencies = function() {
            return ["css/OutSystemsReactWidgets.css", "css/MobilePatterns.BaseTheme.css", "css/MobileThemes_WTF.WTF_BaseTheme.css", "css/WTF_MOB.WTF_MOB.css", "css/WTF_MOB.ZonaFlow.WTF_AditivosChoose_Error.css", "css/MobilePatterns.BaseTheme.extra.css"];
        };
        ...
        Object.defineProperty(View.prototype, "modelFactory", {
            get: function () {
                return WTF_MOB_ZonaFlow_WTF_AditivosChoose_Error_mvc_model;
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(View.prototype, "controllerFactory", {
            get: function () {
                return WTF_MOB_ZonaFlow_WTF_AditivosChoose_Error_mvc_controller;
            },
            enumerable: true,
            configurable: true
        });
...
PageType: "Consulta",
ScreenName: "WTF_AditivosChoose_Error",
PageTitle: "Erro"
},
events: {
...
animate: false,
extendedProperties: {
"data-style-key": "oeBiRgm8xky_L+c_fWzoIA"
},
style: "b-pinkToBlue",
visible: true,
_idProps: {
...
inputs: {
Title: "Oops!",
Text: model.variables.errorDescIn,
Subtitle: model.variables.errorSubTitleIn
},
events: {
_handleError: function (ex) {
controller.handleError(ex);
...
animate: true,
extendedProperties: {
"data-style-key": "F0qAMl3PW0mffHmzM6+ALw"
},
visible: model.variables.errorWithChargeBtnIn,
_idProps: {
service: idService,
uuid: "7"
},
...
animate: false,
extendedProperties: {
"data-style-key": "2jQC6BLQ6kikpmQWZkyBhg"
},
visible: true,
_idProps: {
service: idService,
...
_dependencies: [asPrimitiveValue(model.variables.errorWithChargeBtnIn), asPrimitiveValue(model.variables.errorSubTitleIn), asPrimitiveValue(model.variables.errorDescIn)]
}));
        };
        return View;
...
define("WTF_MOB.ZonaFlow.WTF_AditivosChoose_Error.mvc$controller", ["OutSystems", "WTF_MOB.model", "WTF_MOB.controller", "MobileUIWidgets.controller", "WTF_MOB.languageResources", "WTF_MOB.ZonaFlow.controller", "MobileUIWidgets.controller$CustomFeedbackMessage", "WTF_MOB.referencesHealth", "WTF_MOB.referencesHealth$MobileUIWidgets", "WTF_MOB.controller$Analytics_TrackException", "WTF_MOB.controller$VerifyNetworkStatus", "WTF_MOB.controller$Analytics_SendEvent", "WTF_MOB.controller$StopTraceGlobalAction", "WTF_MOB.controller$StartTraceGlobalAction", "WTF_MOB.model$AnalyticsAuxVarRec"], function (OutSystems, WTF_MOBModel, WTF_MOBController, MobileUIWidgetsController, WTF_MOBLanguageResources, WTF_MOB_ZonaFlowController) {
var OS = OutSystems.Internal;
...
model.flush();
return WTF_MOBController.default.analytics_SendEvent$Action("click", model.variables.analyticsAuxVarVar.categoryAttr, "Voltar ao início", 0, "", callContext).then(function () {
...
OS.Logger.trace("WTF_AditivosChoose_Error.Back", OS.Exceptions.getMessage(ex), ex.name);
...
// Execute Action: Analytics_SendEvent
model.flush();
return WTF_MOBController.default.analytics_SendEvent$Action("click", model.variables.analyticsAuxVarVar.categoryAttr, "Carregar Saldo", 0, "", callContext).then(function () {
...
OS.Logger.trace("WTF_AditivosChoose_Error.GoToCharge", OS.Exceptions.getMessage(ex), ex.name);
// Handle Error: CommunicationException
if(OS.Exceptions.isInstanceOf(ex, OS.Exceptions.Exceptions.CommunicationException)) {
OS.Logger.error(null, ex);
communicationExceptionVar.value.exceptionMessageAttr = OS.Exceptions.getMessage(ex);
...
OS.Logger.trace("WTF_AditivosChoose_Error.OnInitialize", OS.Exceptions.getMessage(ex), ex.name);
// Handle Error: CommunicationException
if(OS.Exceptions.isInstanceOf(ex, OS.Exceptions.Exceptions.CommunicationException)) {
OS.Logger.error(null, ex);
communicationExceptionVar.value.exceptionMessageAttr = OS.Exceptions.getMessage(ex);
