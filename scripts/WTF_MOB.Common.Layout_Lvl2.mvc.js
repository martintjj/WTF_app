define("WTF_MOB.Common.Layout_Lvl2.mvc$model", ["OutSystems", "WTF_MOB.model", "MobileUIWidgets.controller", "MobilePatterns.controller", "WTF_MOB.controller", "WTF_MBP.controller", "CommonPlugin.model", "BuildInfoPlugin.controller", "Essentials_MOB.controller", "NewFirebaseMobilePlugin_WTF.model", "WTF_MBP.model", "MobileUIWidgets.WidgetsInteraction.PullToRefresh_v2_Ext.mvc$model", "WTF_MOB.Common.Header_Lvl1.mvc$model", "WTF_MOB.Common.OfflineDataSyncEvents.mvc$model", "NewFirebaseMobilePlugin_WTF.Firebase.Firebase_Block.mvc$model", "WTF_MOB.Common.GoogleAnalyticsInitialization.mvc$model", "MobileUIWidgets.controller$CloseFeedbackMessage", "WTF_MOB.referencesHealth", "WTF_MOB.referencesHealth$MobileUIWidgets", "MobilePatterns.controller$LayoutReady", "WTF_MOB.referencesHealth$MobilePatterns", "WTF_MOB.controller$CheckIsIOS10", "MobileUIWidgets.controller$Info", "WTF_MBP.controller$GetConfigValueAsText_MBP", "WTF_MOB.referencesHealth$WTF_MBP", "CommonPlugin.model$ErrorRec", "WTF_MOB.referencesHealth$CommonPlugin", "BuildInfoPlugin.controller$GetBuildInfo", "WTF_MOB.referencesHealth$BuildInfoPlugin", "Essentials_MOB.controller$CurrentOS", "WTF_MOB.referencesHealth$Essentials_MOB", "NewFirebaseMobilePlugin_WTF.model$NotificationDataRec", "WTF_MOB.referencesHealth$NewFirebaseMobilePlugin_WTF", "WTF_MBP.controller$ClearCache", "WTF_MBP.controller$DeleteAllLocal_LOCALDYNAMICLINK", "WTF_MOB.model$Local_TEMPDYNAMICLINKRecord", "WTF_MBP.controller$CreateOrUpdateLocal_LOCALDYNAMICLINK", "WTF_MBP.model$Local_TEMPDYNAMICLINKRec", "WTF_MOB.model$Local_ACCESS_TOKEN_INFORecordList", "WTF_MOB.model$Local_USER_WTFRecordList", "WTF_MBP.model$Local_ACCESS_TOKEN_INFORec", "WTF_MBP.model$Local_USER_WTFRec", "WTF_MBP.entities", "WTF_MOB.controller$ValidateUserSession", "WTF_MBP.controller$SetURL", "WTF_MOB.controller$CheckCordovaIsDefinedAndLockOrientation", "WTF_MBP.controller$GetLayoutLevelsAppConfigs", "WTF_MOB.controller$Logout", "WTF_MBP.controller$ValidateIfUserAreBlocked", "WTF_MOB.model$Local_LAYOUT_LEVELSRecordList", "WTF_MBP.model$Local_LAYOUT_LEVELSRec"], function (OutSystems, WTF_MOBModel, MobileUIWidgetsController, MobilePatternsController, WTF_MOBController, WTF_MBPController, CommonPluginModel, BuildInfoPluginController, Essentials_MOBController, NewFirebaseMobilePlugin_WTFModel, WTF_MBPModel, MobileUIWidgets_WidgetsInteraction_PullToRefresh_v2_Ext_mvcModel, WTF_MOB_Common_Header_Lvl1_mvcModel, WTF_MOB_Common_OfflineDataSyncEvents_mvcModel, NewFirebaseMobilePlugin_WTF_Firebase_Firebase_Block_mvcModel, WTF_MOB_Common_GoogleAnalyticsInitialization_mvcModel) {
...
this.attr("HasBackgroundChristmas", "hasBackgroundChristmasIn", "HasBackgroundChristmas", true, OS.Types.Boolean, function () {
return false;
}), 
this.attr("_hasBackgroundChristmasInDataFetchStatus", "_hasBackgroundChristmasInDataFetchStatus", "_hasBackgroundChristmasInDataFetchStatus", true, OS.Types.Integer, function () {
return /*Fetched*/ 1;
})
...
Model._hasValidationWidgetsValue = ((((MobileUIWidgets_WidgetsInteraction_PullToRefresh_v2_Ext_mvcModel.hasValidationWidgets || WTF_MOB_Common_Header_Lvl1_mvcModel.hasValidationWidgets) || WTF_MOB_Common_OfflineDataSyncEvents_mvcModel.hasValidationWidgets) || NewFirebaseMobilePlugin_WTF_Firebase_Firebase_Block_mvcModel.hasValidationWidgets) || WTF_MOB_Common_GoogleAnalyticsInitialization_mvcModel.hasValidationWidgets);
}
...
if("HasBackgroundChristmas" in inputs) {
this.variables.hasBackgroundChristmasIn = inputs.HasBackgroundChristmas;
if("_hasBackgroundChristmasInDataFetchStatus" in inputs) {
this.variables._hasBackgroundChristmasInDataFetchStatus = inputs._hasBackgroundChristmasInDataFetchStatus;
}
...
define("WTF_MOB.Common.Layout_Lvl2.mvc$view", ["OutSystems", "WTF_MOB.model", "WTF_MOB.controller", "MobileUIWidgets.controller", "MobilePatterns.controller", "WTF_MBP.controller", "CommonPlugin.model", "BuildInfoPlugin.controller", "Essentials_MOB.controller", "NewFirebaseMobilePlugin_WTF.model", "WTF_MBP.model", "react", "OutSystemsReactView", "WTF_MOB.Common.Layout_Lvl2.mvc$model", "WTF_MOB.Common.Layout_Lvl2.mvc$controller", "OutSystemsReactWidgets", "MobileUIWidgets.WidgetsInteraction.PullToRefresh_v2_Ext.mvc$view", "WTF_MOB.Common.Header_Lvl1.mvc$view", "WTF_MOB.Common.OfflineDataSyncEvents.mvc$view", "NewFirebaseMobilePlugin_WTF.Firebase.Firebase_Block.mvc$view", "WTF_MOB.Common.GoogleAnalyticsInitialization.mvc$view", "MobileUIWidgets.controller$CloseFeedbackMessage", "WTF_MOB.referencesHealth", "WTF_MOB.referencesHealth$MobileUIWidgets", "MobilePatterns.controller$LayoutReady", "WTF_MOB.referencesHealth$MobilePatterns", "WTF_MOB.controller$CheckIsIOS10", "MobileUIWidgets.controller$Info", "WTF_MBP.controller$GetConfigValueAsText_MBP", "WTF_MOB.referencesHealth$WTF_MBP", "CommonPlugin.model$ErrorRec", "WTF_MOB.referencesHealth$CommonPlugin", "BuildInfoPlugin.controller$GetBuildInfo", "WTF_MOB.referencesHealth$BuildInfoPlugin", "Essentials_MOB.controller$CurrentOS", "WTF_MOB.referencesHealth$Essentials_MOB", "NewFirebaseMobilePlugin_WTF.model$NotificationDataRec", "WTF_MOB.referencesHealth$NewFirebaseMobilePlugin_WTF", "WTF_MBP.controller$ClearCache", "WTF_MBP.controller$DeleteAllLocal_LOCALDYNAMICLINK", "WTF_MOB.model$Local_TEMPDYNAMICLINKRecord", "WTF_MBP.controller$CreateOrUpdateLocal_LOCALDYNAMICLINK", "WTF_MBP.model$Local_TEMPDYNAMICLINKRec", "WTF_MOB.model$Local_ACCESS_TOKEN_INFORecordList", "WTF_MOB.model$Local_USER_WTFRecordList", "WTF_MBP.model$Local_ACCESS_TOKEN_INFORec", "WTF_MBP.model$Local_USER_WTFRec", "WTF_MBP.entities", "WTF_MOB.controller$ValidateUserSession", "WTF_MBP.controller$SetURL", "WTF_MOB.controller$CheckCordovaIsDefinedAndLockOrientation", "WTF_MBP.controller$GetLayoutLevelsAppConfigs", "WTF_MOB.controller$Logout", "WTF_MBP.controller$ValidateIfUserAreBlocked", "WTF_MOB.model$Local_LAYOUT_LEVELSRecordList", "WTF_MBP.model$Local_LAYOUT_LEVELSRec"], function (OutSystems, WTF_MOBModel, WTF_MOBController, MobileUIWidgetsController, MobilePatternsController, WTF_MBPController, CommonPluginModel, BuildInfoPluginController, Essentials_MOBController, NewFirebaseMobilePlugin_WTFModel, WTF_MBPModel, React, OSView, WTF_MOB_Common_Layout_Lvl2_mvc_model, WTF_MOB_Common_Layout_Lvl2_mvc_controller, OSWidgets, MobileUIWidgets_WidgetsInteraction_PullToRefresh_v2_Ext_mvc_view, WTF_MOB_Common_Header_Lvl1_mvc_view, WTF_MOB_Common_OfflineDataSyncEvents_mvc_view, NewFirebaseMobilePlugin_WTF_Firebase_Firebase_Block_mvc_view, WTF_MOB_Common_GoogleAnalyticsInitialization_mvc_view) {
    var OS = OutSystems.Internal;
...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    var View = (function (_super) {
        ...
        View.displayName = "Common.Layout_Lvl2";
        ...
        View.getBlocks = function() {
            return [MobileUIWidgets_WidgetsInteraction_PullToRefresh_v2_Ext_mvc_view, WTF_MOB_Common_Header_Lvl1_mvc_view, WTF_MOB_Common_OfflineDataSyncEvents_mvc_view, NewFirebaseMobilePlugin_WTF_Firebase_Firebase_Block_mvc_view, WTF_MOB_Common_GoogleAnalyticsInitialization_mvc_view];
        };
        Object.defineProperty(View.prototype, "modelFactory", {
            get: function () {
                return WTF_MOB_Common_Layout_Lvl2_mvc_model;
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(View.prototype, "controllerFactory", {
            get: function () {
                return WTF_MOB_Common_Layout_Lvl2_mvc_controller;
            },
            enumerable: true,
            configurable: true
        });
...
align: /*Default*/ 0,
animate: false,
style: model.getCachedValue(idService.getId("5nSh85h_jUi+1sp1XpfAcQ.Style"), function () {
...
align: /*Default*/ 0,
animate: false,
style: model.getCachedValue(idService.getId("xTGfiEOMrEOjiw0MuxN2RA.Style"), function () {
...
align: /*Default*/ 0,
animate: false,
style: model.getCachedValue(idService.getId("abG36uZzCkOGGggUilg7xA.Style"), function () {
return ((model.variables.hasBackgroundChristmasIn) ? ("christmas_background") : (""));
}, function () {
return model.variables.hasBackgroundChristmasIn;
}),
visible: true,
_idProps: {
service: idService,
...
_widgetRecordProvider: widgetsRecordProvider,
style_dataFetchStatus: OS.Model.calculateDataFetchStatus(model.variables._hasBackgroundChristmasInDataFetchStatus)
}, React.createElement(OSWidgets.Placeholder, {
align: /*Default*/ 0,
...
define("WTF_MOB.Common.Layout_Lvl2.mvc$controller", ["OutSystems", "WTF_MOB.model", "WTF_MOB.controller", "MobileUIWidgets.controller", "MobilePatterns.controller", "WTF_MBP.controller", "CommonPlugin.model", "BuildInfoPlugin.controller", "Essentials_MOB.controller", "NewFirebaseMobilePlugin_WTF.model", "WTF_MBP.model", "WTF_MOB.languageResources", "WTF_MOB.Common.Layout_Lvl2.mvc$controller.FirebaseCloudMessagingNewNotification.AddListenerToFeedbackMessageJS", "WTF_MOB.Common.Layout_Lvl2.mvc$controller.Firebase_BlockDynamicLinkEvent.GetLinkFromJSONJS", "WTF_MOB.Common.Layout_Lvl2.mvc$controller.OnInitializeSessionStorage.GetURLJS", "WTF_MOB.Common.Layout_Lvl2.mvc$controller.OnInitializeSessionStorage.SessionStorage_GetURLJS", "MobileUIWidgets.controller$CloseFeedbackMessage", "WTF_MOB.referencesHealth", "WTF_MOB.referencesHealth$MobileUIWidgets", "MobilePatterns.controller$LayoutReady", "WTF_MOB.referencesHealth$MobilePatterns", "WTF_MOB.controller$CheckIsIOS10", "MobileUIWidgets.controller$Info", "WTF_MBP.controller$GetConfigValueAsText_MBP", "WTF_MOB.referencesHealth$WTF_MBP", "CommonPlugin.model$ErrorRec", "WTF_MOB.referencesHealth$CommonPlugin", "BuildInfoPlugin.controller$GetBuildInfo", "WTF_MOB.referencesHealth$BuildInfoPlugin", "Essentials_MOB.controller$CurrentOS", "WTF_MOB.referencesHealth$Essentials_MOB", "NewFirebaseMobilePlugin_WTF.model$NotificationDataRec", "WTF_MOB.referencesHealth$NewFirebaseMobilePlugin_WTF", "WTF_MBP.controller$ClearCache", "WTF_MBP.controller$DeleteAllLocal_LOCALDYNAMICLINK", "WTF_MOB.model$Local_TEMPDYNAMICLINKRecord", "WTF_MBP.controller$CreateOrUpdateLocal_LOCALDYNAMICLINK", "WTF_MBP.model$Local_TEMPDYNAMICLINKRec", "WTF_MOB.model$Local_ACCESS_TOKEN_INFORecordList", "WTF_MOB.model$Local_USER_WTFRecordList", "WTF_MBP.model$Local_ACCESS_TOKEN_INFORec", "WTF_MBP.model$Local_USER_WTFRec", "WTF_MBP.entities", "WTF_MOB.controller$ValidateUserSession", "WTF_MBP.controller$SetURL", "WTF_MOB.controller$CheckCordovaIsDefinedAndLockOrientation", "WTF_MBP.controller$GetLayoutLevelsAppConfigs", "WTF_MOB.controller$Logout", "WTF_MBP.controller$ValidateIfUserAreBlocked", "WTF_MOB.model$Local_LAYOUT_LEVELSRecordList", "WTF_MBP.model$Local_LAYOUT_LEVELSRec"], function (OutSystems, WTF_MOBModel, WTF_MOBController, MobileUIWidgetsController, MobilePatternsController, WTF_MBPController, CommonPluginModel, BuildInfoPluginController, Essentials_MOBController, NewFirebaseMobilePlugin_WTFModel, WTF_MBPModel, WTF_MOBLanguageResources, WTF_MOB_Common_Layout_Lvl2_mvc_controller_FirebaseCloudMessagingNewNotification_AddListenerToFeedbackMessageJS, WTF_MOB_Common_Layout_Lvl2_mvc_controller_Firebase_BlockDynamicLinkEvent_GetLinkFromJSONJS, WTF_MOB_Common_Layout_Lvl2_mvc_controller_OnInitializeSessionStorage_GetURLJS, WTF_MOB_Common_Layout_Lvl2_mvc_controller_OnInitializeSessionStorage_SessionStorage_GetURLJS) {
var OS = OutSystems.Internal;
...
callContext = controller.callContext(callContext);
var vars = new OS.DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("WTF_MOB.Common.Layout_Lvl2.TriggerOnSyncComplete$vars"))());
...
Controller.registerVariableGroupType("WTF_MOB.Common.Layout_Lvl2.TriggerOnSyncComplete$vars", [{
name: "SyncUnit",
...
callContext = controller.callContext(callContext);
var vars = new OS.DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("WTF_MOB.Common.Layout_Lvl2.FirebaseCloudMessagingNewNotification$vars"))());
...
controller.safeExecuteJSNode(WTF_MOB_Common_Layout_Lvl2_mvc_controller_FirebaseCloudMessagingNewNotification_AddListenerToFeedbackMessageJS, "AddListenerToFeedbackMessage", "FirebaseCloudMessagingNewNotification", {
...
Controller.registerVariableGroupType("WTF_MOB.Common.Layout_Lvl2.FirebaseCloudMessagingNewNotification$vars", [{
...
callContext = controller.callContext(callContext);
var vars = new OS.DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("WTF_MOB.Common.Layout_Lvl2.TriggerOnSyncError$vars"))());
vars.value.syncUnitInLocal = syncUnitIn;
...
Controller.registerVariableGroupType("WTF_MOB.Common.Layout_Lvl2.TriggerOnSyncError$vars", [{
name: "SyncUnit",
attrName: "syncUnitInLocal",
mandatory: true,
dataType: OS.Types.Text,
...
callContext = controller.callContext(callContext);
var vars = new OS.DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("WTF_MOB.Common.Layout_Lvl2.Firebase_BlockDynamicLinkEvent$vars"))());
...
return OS.Flow.executeAsyncFlow(function () {
getLinkFromJSONJSResult.value = controller.safeExecuteJSNode(WTF_MOB_Common_Layout_Lvl2_mvc_controller_Firebase_BlockDynamicLinkEvent_GetLinkFromJSONJS, "GetLinkFromJSON", "Firebase_BlockDynamicLinkEvent", {
...
var jsNodeResult = new (controller.constructor.getVariableGroupType("WTF_MOB.Common.Layout_Lvl2.Firebase_BlockDynamicLinkEvent$getLinkFromJSONJSResult"))();
...
OS.Logger.trace("Layout_Lvl2.Firebase_BlockDynamicLinkEvent", OS.Exceptions.getMessage(ex), ex.name);
...
Controller.registerVariableGroupType("WTF_MOB.Common.Layout_Lvl2.Firebase_BlockDynamicLinkEvent$vars", [{
name: "Data",
...
Controller.registerVariableGroupType("WTF_MOB.Common.Layout_Lvl2.Firebase_BlockDynamicLinkEvent$getLinkFromJSONJSResult", [{
name: "Link",
attrName: "linkOut",
mandatory: true,
dataType: OS.Types.Text,
...
callContext = controller.callContext(callContext);
var vars = new OS.DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("WTF_MOB.Common.Layout_Lvl2.TriggerOnSyncStart$vars"))());
vars.value.syncUnitInLocal = syncUnitIn;
return OS.Flow.executeAsyncFlow(function () {
...
Controller.registerVariableGroupType("WTF_MOB.Common.Layout_Lvl2.TriggerOnSyncStart$vars", [{
name: "SyncUnit",
attrName: "syncUnitInLocal",
mandatory: true,
dataType: OS.Types.Text,
...
callContext = controller.callContext(callContext);
var vars = new OS.DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("WTF_MOB.Common.Layout_Lvl2.DeeplinkRedirect$vars"))());
...
Controller.registerVariableGroupType("WTF_MOB.Common.Layout_Lvl2.DeeplinkRedirect$vars", [{
name: "Deeplink",
...
callContext = controller.callContext(callContext);
var vars = new OS.DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("WTF_MOB.Common.Layout_Lvl2.Firebase_BlockErrorHandlerEvent$vars"))());
vars.value.dataInLocal = dataIn;
};
Controller.registerVariableGroupType("WTF_MOB.Common.Layout_Lvl2.Firebase_BlockErrorHandlerEvent$vars", [{
name: "Data",
attrName: "dataInLocal",
mandatory: true,
dataType: OS.Types.Text,
...
var getLayoutLevel2Var = new OS.DataTypes.VariableHolder(new (OS.Controller.BaseController.getAggregateOutputType(WTF_MOBModel.Local_LAYOUT_LEVELSRecordList))());
return OS.Flow.executeAsyncFlow(function () {
// AllowPrevious?
return OS.Flow.executeSequence(function () {
if((!(model.variables.allowPreviousIn))) {
sessionStorage_GetURLJSResult.value = controller.safeExecuteJSNode(WTF_MOB_Common_Layout_Lvl2_mvc_controller_OnInitializeSessionStorage_SessionStorage_GetURLJS, "SessionStorage_GetURL", "OnInitializeSessionStorage", {
IsSessionStorageSupported: OS.DataTypes.JSConversions.basicTypeToJS(false, OS.Types.Boolean, true)
}, function ($parameters) {
var jsNodeResult = new (controller.constructor.getVariableGroupType("WTF_MOB.Common.Layout_Lvl2.OnInitializeSessionStorage$sessionStorage_GetURLJSResult"))();
...
getURLJSResult.value = controller.safeExecuteJSNode(WTF_MOB_Common_Layout_Lvl2_mvc_controller_OnInitializeSessionStorage_GetURLJS, "GetURL", "OnInitializeSessionStorage", {
ScreenName: OS.DataTypes.JSConversions.basicTypeToJS("", OS.Types.Text, true)
}, function ($parameters) {
var jsNodeResult = new (controller.constructor.getVariableGroupType("WTF_MOB.Common.Layout_Lvl2.OnInitializeSessionStorage$getURLJSResult"))();
...
// Aggregate: GetLayoutLevel2
var getLayoutLevel2Aggr = function (maxRecords) {
var executeQuery = function () {
...
var qpstLevel = getLayoutLevelsAppConfigsVar.value.lvl2Out;
...
return controller.executeClientAggregate(executeQuery, function () {
return getLayoutLevel2Var.value;
});
};
return getLayoutLevel2Aggr();
}).then(function () {
// Execute Action: SetURL
model.flush();
return WTF_MBPController.default.setURL$Action(getURLJSResult.value.screenNameOut, getLayoutLevel2Var.value.listOut.getCurrent(callContext.iterationContext).local_LAYOUT_LEVELSAttr.idAttr, callContext).then(function (value) {
...
OS.Logger.trace("Layout_Lvl2.OnInitializeSessionStorage", OS.Exceptions.getMessage(ex), ex.name);
// Handle Error: AllExceptions
if(!(OS.Exceptions.isSystem(ex))) {
OS.Logger.error(null, ex);
allExceptionsVar.value.exceptionMessageAttr = OS.Exceptions.getMessage(ex);
...
Controller.registerVariableGroupType("WTF_MOB.Common.Layout_Lvl2.OnInitializeSessionStorage$getURLJSResult", [{
name: "ScreenName",
...
Controller.registerVariableGroupType("WTF_MOB.Common.Layout_Lvl2.OnInitializeSessionStorage$sessionStorage_GetURLJSResult", [{
...
define("WTF_MOB.Common.Layout_Lvl2.mvc$controller.FirebaseCloudMessagingNewNotification.AddListenerToFeedbackMessageJS", [], function () {
...
define("WTF_MOB.Common.Layout_Lvl2.mvc$controller.Firebase_BlockDynamicLinkEvent.GetLinkFromJSONJS", [], function () {
return function ($parameters, $actions, $roles, $public) {
try {
...
define("WTF_MOB.Common.Layout_Lvl2.mvc$controller.OnInitializeSessionStorage.GetURLJS", [], function () {
return function ($parameters, $actions, $roles, $public) {
$parameters.ScreenName = location.pathname;
};
});
define("WTF_MOB.Common.Layout_Lvl2.mvc$controller.OnInitializeSessionStorage.SessionStorage_GetURLJS", [], function () {
return function ($parameters, $actions, $roles, $public) {
if (typeof(Storage) !== "undefined") {
    sessionStorage.lvl2URL = location.pathname;
    sessionStorage.lvl3URL = "";
