define("Mobile_LoginNOS.OAuth_Flow_Android.NOSID_Password.mvc$model", ["OutSystems", "Mobile_LoginNOS.model", "Mobile_LoginNOS.controller", "MobileUIWidgets.WidgetsContent.CardFlex.mvc$model", "MobileUIWidgets.WidgetsContent.NOSAppsIcons.mvc$model", "ViewControllerPlugin.Main_ViewController.ViewController.mvc$model", "Mobile_LoginNOS.controller$BuildApplicationIdentifier", "Mobile_LoginNOS.controller$Audit", "Mobile_LoginNOS.controller$ViewControllerValidation", "Mobile_LoginNOS.model$WebView_ParametersRec"], function (OutSystems, Mobile_LoginNOSModel, Mobile_LoginNOSController, MobileUIWidgets_WidgetsContent_CardFlex_mvcModel, MobileUIWidgets_WidgetsContent_NOSAppsIcons_mvcModel, ViewControllerPlugin_Main_ViewController_ViewController_mvcModel) {
...
define("Mobile_LoginNOS.OAuth_Flow_Android.NOSID_Password.mvc$view", ["OutSystems", "Mobile_LoginNOS.model", "Mobile_LoginNOS.controller", "react", "OutSystemsReactView", "Mobile_LoginNOS.OAuth_Flow_Android.NOSID_Password.mvc$model", "Mobile_LoginNOS.OAuth_Flow_Android.NOSID_Password.mvc$controller", "MobileUIWidgets.WidgetsContent.CardFlex.mvc$view", "OutSystemsReactWidgets", "MobileUIWidgets.WidgetsContent.NOSAppsIcons.mvc$view", "ViewControllerPlugin.Main_ViewController.ViewController.mvc$view", "Mobile_LoginNOS.controller$BuildApplicationIdentifier", "Mobile_LoginNOS.controller$Audit", "Mobile_LoginNOS.controller$ViewControllerValidation", "Mobile_LoginNOS.model$WebView_ParametersRec"], function (OutSystems, Mobile_LoginNOSModel, Mobile_LoginNOSController, React, OSView, Mobile_LoginNOS_OAuth_Flow_Android_NOSID_Password_mvc_model, Mobile_LoginNOS_OAuth_Flow_Android_NOSID_Password_mvc_controller, MobileUIWidgets_WidgetsContent_CardFlex_mvc_view, OSWidgets, MobileUIWidgets_WidgetsContent_NOSAppsIcons_mvc_view, ViewControllerPlugin_Main_ViewController_ViewController_mvc_view) {
    var OS = OutSystems.Internal;
...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    var View = (function (_super) {
        ...
        View.displayName = "OAuth_Flow_Android.NOSID_Password";
        ...
        Object.defineProperty(View.prototype, "modelFactory", {
            get: function () {
                return Mobile_LoginNOS_OAuth_Flow_Android_NOSID_Password_mvc_model;
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(View.prototype, "controllerFactory", {
            get: function () {
                return Mobile_LoginNOS_OAuth_Flow_Android_NOSID_Password_mvc_controller;
            },
            enumerable: true,
            configurable: true
        });
...
define("Mobile_LoginNOS.OAuth_Flow_Android.NOSID_Password.mvc$controller", ["OutSystems", "Mobile_LoginNOS.model", "Mobile_LoginNOS.controller", "Mobile_LoginNOS.languageResources", "Mobile_LoginNOS.controller$BuildApplicationIdentifier", "Mobile_LoginNOS.controller$Audit", "Mobile_LoginNOS.controller$ViewControllerValidation", "Mobile_LoginNOS.model$WebView_ParametersRec"], function (OutSystems, Mobile_LoginNOSModel, Mobile_LoginNOSController, Mobile_LoginNOSLanguageResources) {
var OS = OutSystems.Internal;
...
return controller.callServerAction("Password", "screenservices/Mobile_LoginNOS/OAuth_Flow_Android/NOSID_Password/ActionPassword", "XE7DAqfmdD6eZ63EJOapXw", inputs, controller.callContext(callContext)).then(function (outputs) {
var executeServerActionResult = new (controller.constructor.getVariableGroupType("Mobile_LoginNOS.OAuth_Flow_Android.NOSID_Password$ActionPassword"))();
executeServerActionResult.uRLOut = OS.DataTypes.JSConversions.jsToBasicType(outputs.URL, OS.Types.Text);
return executeServerActionResult;
});
};
Controller.registerVariableGroupType("Mobile_LoginNOS.OAuth_Flow_Android.NOSID_Password$ActionPassword", [{
name: "URL",
attrName: "uRLOut",
mandatory: false,
...
Mobile_LoginNOSController.default.audit$Action(model.variables.applicationNameIn, ("NOSID_Password | URL End Point: " + passwordVar.value.uRLOut), callContext);
...
OS.Logger.trace("NOSID_Password.PasswordOnNOSID", OS.Exceptions.getMessage(ex), ex.name);
