...
define("WTF_MOB.ZonaFlow.ChangeTarifario_Error.mvc$view", ["OutSystems", "WTF_MOB.model", "WTF_MOB.controller", "MobileUIWidgets.controller", "react", "OutSystemsReactView", "WTF_MOB.ZonaFlow.ChangeTarifario_Error.mvc$model", "WTF_MOB.ZonaFlow.ChangeTarifario_Error.mvc$controller", "WTF_MOB.Common.LayoutBlank.mvc$view", "OutSystemsReactWidgets", "MobileUIWidgets.WidgetsContent.EmptyStatesV2_Text.mvc$view", "MobileUIWidgets.WidgetsContent.ButtonRipple.mvc$view", "WTF_MOB.controller$StopTraceGlobalAction", "WTF_MOB.controller$Analytics_TrackException", "MobileUIWidgets.controller$CustomFeedbackMessage", "WTF_MOB.referencesHealth", "WTF_MOB.referencesHealth$MobileUIWidgets", "WTF_MOB.controller$StartTraceGlobalAction", "WTF_MOB.controller$VerifyNetworkStatus", "WTF_MOB.controller$Analytics_SendEvent", "WTF_MOB.model$AnalyticsAuxVarRec"], function (OutSystems, WTF_MOBModel, WTF_MOBController, MobileUIWidgetsController, React, OSView, WTF_MOB_ZonaFlow_ChangeTarifario_Error_mvc_model, WTF_MOB_ZonaFlow_ChangeTarifario_Error_mvc_controller, WTF_MOB_Common_LayoutBlank_mvc_view, OSWidgets, MobileUIWidgets_WidgetsContent_EmptyStatesV2_Text_mvc_view, MobileUIWidgets_WidgetsContent_ButtonRipple_mvc_view) {
    var OS = OutSystems.Internal;
...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    var View = (function (_super) {
        ...
        View.displayName = "ZonaFlow.ChangeTarifario_Error";
        View.getCssDependencies = function() {
            return ["css/OutSystemsReactWidgets.css", "css/MobilePatterns.BaseTheme.css", "css/MobileThemes_WTF.WTF_BaseTheme.css", "css/WTF_MOB.WTF_MOB.css", "css/WTF_MOB.ZonaFlow.ChangeTarifario_Error.css", "css/MobilePatterns.BaseTheme.extra.css"];
        };
        ...
        Object.defineProperty(View.prototype, "modelFactory", {
            get: function () {
                return WTF_MOB_ZonaFlow_ChangeTarifario_Error_mvc_model;
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(View.prototype, "controllerFactory", {
            get: function () {
                return WTF_MOB_ZonaFlow_ChangeTarifario_Error_mvc_controller;
            },
            enumerable: true,
            configurable: true
        });
...
ScreenName: "ChangeTarifario_Error",
PageType: "Consulta"
},
events: {
...
animate: false,
extendedProperties: {
"data-style-key": "LpijuLh0RUO4bA0y4dPOlQ"
},
style: "b-pinkToBlue",
visible: true,
_idProps: {
...
inputs: {
Text: "O teu saldo não é suficiente para continuar esta operação. Por favor, carrega-o e tenta outra vez.",
Title: "OOPS!"
},
events: {
_handleError: function (ex) {
...
animate: false,
extendedProperties: {
"data-style-key": "mviK75Qu4EqoZrHcQAKMQA"
},
visible: true,
_idProps: {
service: idService,
...
animate: false,
extendedProperties: {
"data-style-key": "VZOSwnxqIUasUpXz0FVp1g"
},
visible: true,
_idProps: {
service: idService,
...
define("WTF_MOB.ZonaFlow.ChangeTarifario_Error.mvc$controller", ["OutSystems", "WTF_MOB.model", "WTF_MOB.controller", "MobileUIWidgets.controller", "WTF_MOB.languageResources", "WTF_MOB.ZonaFlow.controller", "WTF_MOB.controller$StopTraceGlobalAction", "WTF_MOB.controller$Analytics_TrackException", "MobileUIWidgets.controller$CustomFeedbackMessage", "WTF_MOB.referencesHealth", "WTF_MOB.referencesHealth$MobileUIWidgets", "WTF_MOB.controller$StartTraceGlobalAction", "WTF_MOB.controller$VerifyNetworkStatus", "WTF_MOB.controller$Analytics_SendEvent", "WTF_MOB.model$AnalyticsAuxVarRec"], function (OutSystems, WTF_MOBModel, WTF_MOBController, MobileUIWidgetsController, WTF_MOBLanguageResources, WTF_MOB_ZonaFlowController) {
var OS = OutSystems.Internal;
...
OS.Logger.trace("ChangeTarifario_Error.OnInitialize", OS.Exceptions.getMessage(ex), ex.name);
...
model.flush();
return WTF_MOBController.default.analytics_SendEvent$Action("click", "Mudar Tarifario", "Voltar", 0, "", callContext).then(function () {
...
OS.Logger.trace("ChangeTarifario_Error.Back", OS.Exceptions.getMessage(ex), ex.name);
// Handle Error: CommunicationException
if(OS.Exceptions.isInstanceOf(ex, OS.Exceptions.Exceptions.CommunicationException)) {
OS.Logger.error(null, ex);
communicationExceptionVar.value.exceptionMessageAttr = OS.Exceptions.getMessage(ex);
...
// Execute Action: Analytics_SendEvent
model.flush();
return WTF_MOBController.default.analytics_SendEvent$Action("click", "Mudar Tarifario", "Carregar Saldo", 0, "", callContext).then(function () {
...
OS.Logger.trace("ChangeTarifario_Error.GoToCharge", OS.Exceptions.getMessage(ex), ex.name);
// Handle Error: CommunicationException
if(OS.Exceptions.isInstanceOf(ex, OS.Exceptions.Exceptions.CommunicationException)) {
OS.Logger.error(null, ex);
communicationExceptionVar.value.exceptionMessageAttr = OS.Exceptions.getMessage(ex);
